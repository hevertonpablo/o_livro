...
> Tarefas pendentes do projeto, priorizadas.
>
> **Convenção:**
> - `[ ]` — pendente
> - `[x]` — concluído
...
- [ ] Criar `livros/livro-01-lara/changelog.md` (histórico do livro).
- [ ] Criar `livros/livro-01-lara/capitulos/` (pasta vazia inicial).

---

## 🟡 Prioridade MÉDIA — Estrutura agentic

### Skills
- [ ] Criar `skills/escrita-capitulo.md`.
- [ ] Criar `skills/revisao-continuidade.md`.
- [ ] Criar `skills/plantio-pistas.md`.
- [ ] Criar `skills/revisao-literaria.md`.
- [ ] Criar `skills/revisao-tom-sensivel.md`.
- [ ] Criar `skills/preparacao-kdp.md`.

### Prompts
- [ ] Criar `prompts/escrever-capitulo.md`.
- [ ] Criar `prompts/revisar-capitulo.md`.
- [ ] Criar `prompts/checar-continuidade.md`.
- [ ] Criar `prompts/criar-outline.md`.
...
- [ ] Definir símbolo de cada protagonista (capa + abertura de partes).
- [ ] Definir paleta de cores por livro.
- [ ] Decidir lombada-surpresa (imagem oculta entre os 10 livros).
...
### Sobre Elias
- [ ] Decidir idade exata no tempo principal (vivo 50–65 ou falecido com presença forte).
- [ ] Decidir ofício (música / mentoria / combinação).
- [ ] Decidir conteúdo integral da carta antiga.
- [ ] Decidir quem foi a pessoa que Elias mais machucou ao partir.
- [ ] Decidir forma de revelação em L9 (autobiográfica / dialógica / escrita / mista).

### Sobre Noemi
- [ ] Definir material e cor exatos da mala antiga.
- [ ] Definir conteúdo (decisão da Fase 2 — apenas anotação interna).

---

## 🟢 Prioridade BAIXA — Polimento e expansão

### Sobre série e publicação
- [ ] Definir título oficial da série.
- [ ] Criar sinopses comerciais por livro.
- [ ] Definir nomes definitivos dos volumes (capa).
- [ ] Definir estratégia de publicação (auto / editora / digital primeiro).

### Sobre experiência do leitor
- [ ] Decidir se haverá site / suplemento extra para a comunidade decodificar.
- [ ] Pensar em audiobook (como tratar fragmentos visuais).
- [ ] Pensar em e-book (como adaptar boxes e fragmentos).

### Sobre Fase 2
- [ ] Esboçar arco geral da Fase 2.
- [ ] Listar personagens-semente prioritários para Fase 2.
- [ ] Decidir intervalo entre Fase 1 e Fase 2.

---

## Tarefas concluídas (recente)

- [x] Criar PRDs (escopo, prd-literario, prd-direcao-literaria) — 2026-05-06.
- [x] Criar Bíblia de Continuidade (hub) — 2026-05-06.
- [x] Criar pasta `personagens/` com 46 fichas — 2026-05-06.
- [x] Criar Bíblia de Cenários e pasta `cenarios/` — 2026-05-06.
- [x] Criar Bíblia de Clima e pasta `clima/` — 2026-05-06.
- [x] Criar Bíblia de Lugares e pasta `lugares/` — 2026-05-06.
- [x] Criar Bíblia de Objetos e pasta `objetos/` — 2026-05-06.
- [x] Criar Bíblia de Horários e pasta `horarios/` — 2026-05-07.
- [x] Criar Bíblia de Personagens — 2026-05-07.
- [x] Criar Bíblia de Relações — 2026-05-07.
- [x] Criar Bíblia do Antigo — 2026-05-07.
- [x] Criar Bíblia do Personagem Oculto — 2026-05-07.
- [x] Criar Bíblia de Elias — 2026-05-07.
- [x] Criar Bíblia de Pistas, Códigos e Charadas — 2026-05-07.
...
- Toda nova tarefa entra com prioridade clara.
- Tarefas que dependem de decisão pendente recebem `[?]` e referenciam o `DEC-XXX`.
- Tarefas concluídas migram para a seção "Tarefas concluídas (recente)" — mantenha as últimas ~20.
- Antes de iniciar trabalho, **conferir esta lista** e atualizar a tarefa para `[~]`.
